...
void World::guideMissiles()
{
	...
	missileGuider.action = derivedAction<Projectile>([this] (Projectile& missile, sf::Time)
	{
		...
		// Find closest enemy
		for (auto itr = mActiveEnemies.begin(); itr != mActiveEnemies.end(); ++itr){

			float enemyDistance = distance(missile, **itr);
